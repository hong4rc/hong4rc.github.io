...
<section class="contact" use:reveal>
	...
	<div class="links">
		<a
			...
			class="link"
			style="--color: #ea4335"
			onclick={() => trackSocialClick('email', 'contact_section')}
		>
		...
		<a
			href={addUTM(config.contact.github, { content: 'contact' })}
			target="_blank"
			rel="noopener"
			class="link"
			style="--color: #fff"
			onclick={() => trackSocialClick('github', 'contact_section')}
		>
			<svg viewBox="0 0 24 24" fill="currentColor" class="icon" aria-hidden="true">
		...
		<a
			href={addUTM(config.contact.linkedin, { content: 'contact' })}
			target="_blank"
			rel="noopener"
			class="link"
			style="--color: #0a66c2"
